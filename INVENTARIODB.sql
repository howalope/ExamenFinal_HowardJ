...
as
	begin
		insert into Usuarios (Codigo_Usuario,Nombre_Usuario,Clave_Usuario,Tipo_Usuario)
		select @CodigoU, @nombreU, @claveU, @tipoU from Usuarios where Codigo_Usuario = @codigoU
	end
